...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MyCVUser.github_username'
        db.add_column(u'accounts_mycvuser', 'github_username',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MyCVUser.github_username'
        db.delete_column(u'accounts_mycvuser', 'github_username')
    ...
    models = {
        u'accounts.mycvuser': {
            ...
            'github_username': ('django.db.models.fields.CharField', [], {'max_length': '30', 'blank': 'True'}),
